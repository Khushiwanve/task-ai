...
[![CI Check + Auto Deploy](https://github.com/Khushiwanve/task-ai/actions/workflows/deploy.yml/badge.svg)](https://github.com/Khushiwanve/task-ai/actions/workflows/deploy.yml)
